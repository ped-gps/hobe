...
export class MedicalRecordPrescriptionComponent implements OnInit {
    ...
    isMedicalAppointmentInProgress() {
        return this.medicalAppointment.situation === MedicalAppointmentSituation.IN_PROGRESS;
    }
    ...
    addMedication(
        ...
        if (dosage.trim() === '') {
            const administrationRoute = AdministrationRouteUtils.getFriendlyName(medication.administrationRoute).toLowerCase();
