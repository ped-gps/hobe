	...
	},
	{
		...
		children: [
			...
			},
			{
				...
				loadComponent: () =>
					import('@hobe/shared').then((m) => m.DashboardComponent),
			},
			{
			...
			},
			{
				...
				loadComponent: () =>
					import('@hobe/shared').then((m) => m.ProceduresComponent),
			},
			{
				path: Route.SCHEDULE,
				loadComponent: () =>
			...
			},
			{
				...
				loadComponent: () =>
					import('@hobe/shared').then(
						(m) => m.MedicalAppointmentsExtractComponent,
					),
			},
			{
				...
				loadComponent: () =>
					import('@hobe/shared').then(
						(m) => m.MedicalInsurancesComponent,
					),
			},
		],
	},
